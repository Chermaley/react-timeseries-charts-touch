            ...
            var handlers = {
                ...
                onTouchStart: function onTouchStart(e) {
                    if (e.touches.length === 2) {
                        ...
                        var touchDistance = Math.hypot(touch1.pageX - touch2.pageX, touch1.pageY - touch2.pageY);
                ...
                onTouchMove: function onTouchMove(e) {
                    if (e.touches.length === 2 && _this2.state.touchDistance !== null) {
                        var touch1 = e.touches[0];
                        var touch2 = e.touches[1];
                        var touchDistance = Math.hypot(touch1.pageX - touch2.pageX, touch1.pageY - touch2.pageY);

                        var SCALE_FACTOR = 0.001;
                        var scale = 1 - (touchDistance - _this2.state.touchDistance) * SCALE_FACTOR;
                        if (scale > 3) {
                            scale = 3;
                        }
                        if (scale < 0.1) {
                        ...
                        var xy = _this2.getOffsetMousePosition(touch1);

                        var begin = _this2.props.scale.domain()[0].getTime();
                        var end = _this2.props.scale.domain()[1].getTime();
                        var center = _this2.props.scale.invert(xy[0]).getTime();
                        ...
                        if (_this2.props.minDuration) {
                            var minDuration = parseInt(_this2.props.minDuration, 10);
                            if (duration < _this2.props.minDuration) {
                                beginScaled = center - (center - begin) / (end - begin) * minDuration;
                                endScaled = center + (end - center) / (end - begin) * minDuration;
                            }
                        }

                        if (_this2.props.minTime && _this2.props.maxTime) {
                            var maxDuration = _this2.props.maxTime.getTime() - _this2.props.minTime.getTime();
                            if (duration > maxDuration) {
                                duration = maxDuration;
                            }
                        }
                        ...
                        // Range constraint
                        if (_this2.props.minTime && beginScaled < _this2.props.minTime.getTime()) {
                            beginScaled = _this2.props.minTime.getTime();
                            endScaled = beginScaled + duration;
                        }

                        if (_this2.props.maxTime && endScaled > _this2.props.maxTime.getTime()) {
                            endScaled = _this2.props.maxTime.getTime();
                            beginScaled = endScaled - duration;
                        }
                        ...
                        if (_this2.props.onZoom) {
                            _this2.props.onZoom(newTimeRange);
                        }
                        ...
                        var _begin = _this2.props.scale.domain()[0].getTime();
                        var _end = _this2.props.scale.domain()[1].getTime();

                        if (!_this2.state.isPanning) {
                            _this2.setState({
                                isPanning: true,
                                initialPanBegin: _begin,
                                initialPanEnd: _end,
                                initialPanPosition: xy0
                            });
                        }
