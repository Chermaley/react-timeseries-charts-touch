...
var EventHandler = function (_React$Component) {
    ...
    _createClass(EventHandler, [{
        ...
        value: function render() {
            ...
            }, _defineProperty(_handlers, "onMouseUp", this.handleMouseUp), _defineProperty(_handlers, "onTouchStart", function onTouchStart(e) {}), _defineProperty(_handlers, "onTouchMove", function onTouchMove(e) {
            ...
            }), _defineProperty(_handlers, "onTouchEnd", function onTouchEnd(e) {
                if (_this2.state.isPanning) {
                    _this2.setState({
                        isPanning: false,
                        initialPanBegin: null,
            ...
            }), _defineProperty(_handlers, "onContextMenu", this.handleContextMenu), _handlers);
...
EventHandler.propTypes = (_EventHandler$propTyp = {
...
}, _defineProperty(_EventHandler$propTyp, "onMouseClick", _react2.default.PropTypes.func), _defineProperty(_EventHandler$propTyp, "onPanZoomEnd", _react2.default.PropTypes.func), _defineProperty(_EventHandler$propTyp, "onContextMenu", _propTypes2.default.func), _EventHandler$propTyp);
